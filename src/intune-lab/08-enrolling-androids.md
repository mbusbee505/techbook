...
![Managed Google Play connection screen in Intune](src/intune-lab/attachments/08-enrolling-androids-1.png)
...
![Warning about using personal Google account](src/intune-lab/attachments/08-enrolling-androids-2.png)
...
![Managed Google Play setup company information](src/intune-lab/attachments/08-enrolling-androids-3.png)
...
![Successful Managed Google Play connection status](src/intune-lab/attachments/08-enrolling-androids-4.png)
...
![Android device showing Company Portal download from Play Store](src/intune-lab/attachments/08-enrolling-androids-5.png)
...
![Android enrollment process overview screen](src/intune-lab/attachments/08-enrolling-androids-6.png)
...
![Android work and personal apps separation explanation](src/intune-lab/attachments/08-enrolling-androids-7.png)
